...
<img src="/img/p2p-mode-view.webp" alt="P2P Mode View" width="75%">

The `Connection status` shows the current device name and the number of connected devices.

<img src="/img/p2p-device-connected.webp" alt="Devices Connected" width="75%">

## Scenarios Where Direct Connection Fails

Relay via a [[cloud-services/turn-server| TURN Server]] is required. For how to deploy it on a NAS, refer to [[build-with-nas | here]].