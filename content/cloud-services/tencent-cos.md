...
If you encounter the error `Failed to set CORS configuration. Please configure it manually`, go to the Bucket List to configure CORS, referring to the figure below:![[config cors.webp]]
