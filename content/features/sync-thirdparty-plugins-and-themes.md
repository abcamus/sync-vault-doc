...
tags:
  ...
  - Theme
---
In the plugin's synchronization settings interface, there are the following options, as shown in the image:<img src="/img/sync-hidden-files.webp" alt="Sync Plugins, Themes, and Hidden Files" width="75%">
